      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <section className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 mb-12 shadow-2xl">
          ...
          <p className="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            ...
            ứng. Chúng tôi "ẩn mình để lớn mạnh" - không ngừng học hỏi và phát
            triển bản thân, đồng thời "đổi mới để dẫn đầu" - luôn tìm kiếm những
            ý tưởng sáng tạo để vượt qua thử thách và đạt được những mục tiêu
            cao nhất!
          </p>
        </section>
